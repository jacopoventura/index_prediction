...
TEST_SIZE = 0.2   # best results with 0.1, 0.15, 0.2

INITIAL_DATE_OF_DATASET = datetime.datetime(2021, 1, 1).date()
INITIAL_DATE_OF_TEST = datetime.datetime(2024, 1, 1).date()
SELECTED_FEATURES = ['hloc', 'volume', 'atr', 'macd', 'aroon', 'adx', 'bollinger', 'rsi', 'ma', 'day', 'price/previous day', 'vix']
...
FEATURE_LIST = predictors_dict["hloc"] + predictors_dict["volume"]
...
# TODO
# 1. final results: Price N days after the close <PRICE CLOSE> on the <DAY CLOSE>: <PREDICTED PRICE>, + [] % with probability of XXX
# 4. put prediction into a separated file (like deployment) + add days label
